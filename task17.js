...
function renderChart() {
	...
	for(var cityName in chartData){
		if(citySelectChange[parseInt(pageState.nowSelectCity)]==cityName){
			var data=chartData[cityName][pageState.nowGraTime];
			for(var d in data){
				var divLabel=document.creatElement("div");
				...
				divLabel.style.background=bgColor[parseInt(Math.random()*5)];
